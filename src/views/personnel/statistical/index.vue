  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      <el-row >
        ...
        <el-col :span="3" >
          <treeselect v-model="queryParams.deptName" :options="deptOptions"  :show-count="true" placeholder="请选择单位" />
        </el-col>
      ...
      <el-row>
        ...
        <el-form-item label="人员状态" >
          <el-select v-model="queryParams.personnelStatus" placeholder="请选择人员状态" clearable size="small">
            <el-option
